    ...
    return (
        ...
        <div className="relative group">
            ...
            <button
                ...
                className="absolute top-1 right-1 bg-black/40 text-white rounded-full w-5 h-5 flex items-center justify-center text-sm leading-none opacity-0 group-hover:opacity-100 transition-opacity duration-150 hover:bg-black/70 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-black"
            >
                &times;
            </button>
        </div>
